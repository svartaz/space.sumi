...
export const codeToTable = (code, showsNumber = false) => {
    ...
    table.querySelector("tr:first-of-type td").style.borderBlockEnd = "1px solid";
    table.querySelector("tr:last-of-type td").style.borderBlockStart = "1px solid";
